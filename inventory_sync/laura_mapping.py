...
# Authoritative exact strings supplied by the PRD owner (2026-07-12), source
# laura/output/family_collection_map.json. Keys are matched after .strip() —
# the file carries hidden leading/trailing spaces on some families.
...
# ⚠️ Inferred by the PRD owner but NOT yet confirmed present in the store.
# Deliberately kept OUT of the active map: until the site owner confirms them,
# these fall to needs_review (safe). To activate, move an entry up into
# COLLECTION_BY_FAMILY.
PENDING_APPROVAL_BY_FAMILY: dict[str, str] = {
